defmodule WorkshopManagementWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WorkshopManagementWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WorkshopManagementWeb.Gettext, "errors", msg, opts)
    end
  end
